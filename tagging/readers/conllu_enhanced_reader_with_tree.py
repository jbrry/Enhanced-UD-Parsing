...
@DatasetReader.register("universal_dependencies_enhanced_tree")
class UniversalDependenciesEnhancedDatasetReaderTree(DatasetReader):
    """
    ...
    def get_distance_categories(self, distance):
        ...
        if 1 <= distance < 5:
            ...
            return '<far>'
        elif 15 <= distance <= 1000:
            return '<long_range>'
        else:
            raise ValueError('unusual distance: {}'.format(distance))
    ...
    def text_to_instance(
        ...
        if dependencies is not None:
            ...
            fields["deprels"] = SequenceLabelField(
                [x[0] for x in dependencies], token_field, label_namespace="deprels"
            )
