...
class RootedAdjacencyField(Field[torch.Tensor]):
    ...
    def __init__(self,
        ...
        # take len of sequence_field as it contains extra ROOT token
        self.field_length = len(sequence_field)
...
#                                     f"are incompatible: {indices} and {field_length}")
    ...
    def get_padding_lengths(self) -> Dict[str, int]:
        return {'num_tokens': self.field_length}
    ...
    def empty_field(self) -> 'RootedAdjacencyField':
        ...
        adjacency_field = RootedAdjacencyField(empty_list,
    ...
    def __str__(self) -> str:
        ...
        return f"RootedAdjacencyField of length {length}\n" \
               f"\t\twith indices:\n {formatted_indices}\n" \
