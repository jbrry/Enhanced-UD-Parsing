...
@Model.register("biaffine_parser_original")
class BiaffineDependencyParserOriginal(Model):
    """
    ...
    def __init__(self,
        ...
        super(BiaffineDependencyParserOriginal, self).__init__(vocab, regularizer)
